	...
	<div class="container" style="max-width: 800px;">
		...
		<div class="card mb-4">
			...
			<div class="grid" style="grid-template-columns: 1fr 2fr; gap: 1rem;">
				...
				<div>
					<span class="badge" class:badge-running={user?.role === 'admin'} class:badge-scheduled={user?.role === 'player'}>
						{user?.role}
					</span>
				</div>
		...
		<div class="card mb-4">
			...
			<button onclick={updateLocation} class="btn-primary" disabled={loading}>
				...
				<table>
					...
					<tbody>
						{#each submissions as submission}
							<tr>
								<td>
									<a href="/tournaments/{submission.tournament_id}" class="text-primary-600">
										View Tournament
									</a>
								</td>
