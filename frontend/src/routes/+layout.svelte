...
<div style="min-height: 100vh; display: flex; flex-direction: column;">
	<nav>
		<div class="nav-content">
			<div class="nav-links">
				...
				<a href="/tournaments" class:active={$page.url.pathname.startsWith('/tournaments')}>
					Tournaments
				</a>
				<a href="/games" class:active={$page.url.pathname.startsWith('/games')}>
					Games
				</a>
	...
	<footer>
		<div class="container">
			<p class="text-sm">&copy; 2025 Axel Tournament Platform. All rights reserved.</p>
		</div>
	</footer>
</div>
